...
dataset = pd.read_csv(r"D:\Data Science & AI class note\14th Feb\14th - NLP project\14th - NLP project\4.CUSTOMERS REVIEW DATASET\Restaurant_Reviews.tsv", delimiter = '\t', quoting = 3)
# Cleaning the texts
import re
import nltk
